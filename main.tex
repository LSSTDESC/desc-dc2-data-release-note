...
\rev{(currently no example notebook available for coadded images)}.
...
We encourage new users to provide feedback and ask questions via the ``Discussions'' feature in the dedicated GitHub repository\footnote{\https{github.com/LSSTDESC/desc-data-portal/discussions}}.
