...
%\clearpage
%
We have recently created a simulated sky survey in order to prepare for the analysis of the Vera C. Rubin Observatory Legacy Survey of Space and Time (LSST) by the LSST DarkEnergy Science Collaboration (LSST DESC). In this Note, we describe the accompanying public data release of the  
