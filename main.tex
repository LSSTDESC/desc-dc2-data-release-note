%\RequirePackage[2024-06-01]{latexrelease}  % Uncomment this line if cannot compile
...
%\PassOptionsToPackage{frozencache=true}{minted}  % Uncomment this line for arXiv submission
